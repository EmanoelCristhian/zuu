    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-8">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-bold">Criar conta no Zuu</CardTitle>
          <CardDescription>Comece a gerenciar seus imóveis gratuitamente</CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="space-y-2">
              ...
              <RadioGroup
                value={role}
                onValueChange={(v) => setValue('role', v as 'locador' | 'locatario')}
                className="flex gap-4"
              >
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="locador" id="locador" />
                  <Label htmlFor="locador">Proprietário / Corretor</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="locatario" id="locatario" />
                  <Label htmlFor="locatario">Inquilino</Label>
                </div>
              </RadioGroup>
            </div>
